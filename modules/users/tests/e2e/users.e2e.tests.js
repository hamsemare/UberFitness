...
describe('Users E2E Tests:', function() {
    ...
    describe('Signup Validation', function() {
        ...
        it('Should report a password with less than 5 characters long - "P@$$w"', function() {
            browser.get('http://localhost:3001/authentication/signup');
            // Enter First Name
            element(by.model('vm.credentials.firstName')).sendKeys(user1.firstName);
            // Enter Last Name
            ...
            element(by.css('button[type=submit]')).click();
            // Password Error
            expect(element.all(by.css('.error-text')).get(0).getText()).toBe('The password must be at least 5 characters long.');
        });
...
>>>>>>> 85147045a4abdc9ad6ebf981e42c444674b75cab
